...
export default function Index() {
  ...
  useEffect(() => {
    // Modo desarrollo - no usar RevenueCat real
    if (__DEV__) {
      console.log("Modo desarrollo: Saltando verificación de RevenueCat");
      return;
    }

    // Solo usar RevenueCat en producción
    getCustomerInfo();
  }, []);
  ...
  async function getCustomerInfo() {
    try {
      if (!Purchases.isConfigured) {
        console.log("RevenueCat no está configurado");
        return;
      }
      ...
      console.log("Error obteniendo información del cliente:", error);
    }
  }
